    ...
    <div class="d-flex justify-content-end">
        <div class="toast bg-grey" role="alert" id="myToast" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <strong class="me-auto">Notofication</strong>
        ...
        <div class="container my-6">
            <div class="row d-flex justify-content-center ">
                <div class="col-lg-6"> <!-- Add col-lg-6 class here -->
                    ...
                    <form class="border border-md bg-light rounded border-black p-4" id="login">
                        <div class="mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $("#login").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "action/login.php", // Replace with the URL of your server-side script to handle form submission
                data: formData,
                dataType: "json",
